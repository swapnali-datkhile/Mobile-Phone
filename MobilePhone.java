...
public class MobilePhone {
    ...
    public boolean modifyContact(Contact oldContact, Contact newContact){
        ...
        if(foundPosition < 0){
            System.out.println(oldContact.getName() +" was not found on file ");
            return false;
    ...
    public boolean removeContact(Contact contact){
        ...
        if(foundPosition < 0){
            System.out.println(contact.getName() +" was not found on file ");
            return false;
        }
        this.myContacts.remove(foundPosition);
        System.out.println(contact.getName() +" was removed from file");
        return true;
    }
